...
const TEST_OWNER_REPEATED = "22222222-2222-4222-8222-222222222222";
const TEST_OWNER_DYNAMIC = "33333333-3333-4333-8333-333333333333";
...
test("repeated-query learning promotes only a stable, safe fallback response", async () => {
  const repository = new DirectCommandRepository(TEST_OWNER_REPEATED);
...
test("dynamic and inconsistent responses never auto-promote", async () => {
  const repository = new DirectCommandRepository(TEST_OWNER_DYNAMIC);
  const learning = new RepeatedQueryLearningService(repository);
